...
let WithdrawalService = class WithdrawalService {
  async request(withdrawalRequestDto) {
    ...
    if (checkExistingWithrawal)
      throw new _common.ForbiddenException('در حال حاضر برداشت فعال دارید');
  ...
  async cancel(id) {
    ...
    if (withdrawal.status !== 'PENDING')
      throw new _common.NotFoundException('NOT IN VALID STATUS');
...
WithdrawalService = _ts_decorate(
  [
    ...
    _ts_metadata('design:paramtypes', [
      typeof _withdrawalrepository.WithdrawalRepository === 'undefined'
        ? Object
