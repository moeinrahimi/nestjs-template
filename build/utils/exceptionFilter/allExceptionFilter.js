...
let AllExceptionsFilter = class AllExceptionsFilter {
        ...
        const httpStatus = exception instanceof _common.HttpException ? exception.getStatus() : _common.HttpStatus.INTERNAL_SERVER_ERROR;
        const responseBody = {
            status: 'failed',
            code: httpStatus,
        ...
        if (exception instanceof _common.HttpException) {
            ...
            if (typeof response === 'string') {
                ...
                responseBody.message = response.message || responseBody.message;
            }
        }
